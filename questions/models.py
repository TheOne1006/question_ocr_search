...
class commonQuestions(models.Model):
    ...
    pic_title = models.CharField(max_length=200, default="", verbose_name="题目图片")
    pic_answer = models.CharField(max_length=200, default="", verbose_name="答案图片")
    ...
    same_guids = models.TextField(max_length=200, default="", verbose_name="同类题guid")
